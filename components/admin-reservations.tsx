...
export default function AdminReservations({ reservations, apartments }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {detailReservation && <DetailModal reservation={detailReservation} onClose={() => setDetailReservation(null)} />}
      {editReservation && (
        <EditModal
...
function DetailModal({ reservation, onClose }: { reservation: ReservationWithApartment; onClose: () => void }) {
  return (
    <div
